...
namespace Surge.Shared.Common.ListFilter
{
        ...
        IComparer<object>
    {
        ...
        private ObservableCollection<SortDescription> _sort;    // sorting parameters
        private Dictionary<string, PropertyInfo> _sortProps;    // PropertyInfo dictionary used while sorting
        ...
        {
            private CollectionChange _cc = CollectionChange.Reset;
            private uint _index = (uint)0xffff;

            private static VectorChangedEventArgs s_reset = new VectorChangedEventArgs(CollectionChange.Reset);
